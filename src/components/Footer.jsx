        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 pb-16 border-b border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {navLinks.map((item) => (
                <li key={item.name}>
                  <Link to={item.path} className="text-gray-400 hover:text-pink-500 transition-colors font-medium text-sm">
                    {item.name}
                  </Link>
                </li>
              ))}
          ...
          {/* Quick Services */}
          <div>
            <h4 className="text-pink-500 font-black uppercase tracking-widest text-sm mb-10">Quick Services</h4>
            <ul className="space-y-4">
